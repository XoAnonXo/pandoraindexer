 ...
 *
 * Home chain dispute resolution contract (Sonic).
 * Handles ERC721 wrapping of AnonStaking NFTs and dispute management.
 */

export const DisputeResolverHomeAbi = [
	// =============================================================================
	// EVENTS
	// =============================================================================
	{
	...
	},
	{
		...
		inputs: [
			...
			{ name: "dstChainEid", type: "uint32", indexed: false },
			{ name: "tokenIds", type: "uint256[]", indexed: false },
		],
	},
	{
		type: "event",
		name: "RemoteClaimSent",
		inputs: [
